							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("EPISODE_ID");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.EPISODE_ID === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "ACMEItems (" + iNumberOfItems + ")"}),
									success : function () {
