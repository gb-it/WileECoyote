sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/devs/wile/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.sap.devs.wile.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/devs/wile/localService/mockserver"], function (mockserver) {
